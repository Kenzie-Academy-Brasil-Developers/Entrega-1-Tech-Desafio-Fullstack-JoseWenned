...
export class CreateMigration1707977970871 implements MigrationInterface {
    name = 'CreateMigration1707977970871'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "clients" ("id" SERIAL NOT NULL, "full_name" character varying(120) NOT NULL, "email" character varying(120) NOT NULL, "password" character varying(200) NOT NULL, "admin" boolean NOT NULL DEFAULT false, "telephone" character varying(15) NOT NULL, "date_register" date NOT NULL DEFAULT now(), CONSTRAINT "UQ_b48860677afe62cd96e12659482" UNIQUE ("email"), CONSTRAINT "UQ_5e1236d7feffe204333944ed649" UNIQUE ("telephone"), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
